...
import (
	"v1alpha1/clientset/versioned/scheme"
...
// StableV1alpha1Client is used to interact with features provided by the stable.anglo-korean.github.io group.
type StableV1alpha1Client struct {
	restClient rest.Interface
}

func (c *StableV1alpha1Client) Cronjobs(namespace string) CronjobInterface {
